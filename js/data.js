...
const I18N = {
  id: {
    ...
    'stack.langs': 'BAHASA',
    'stack.framework': 'FRAMEWORK & UI',
    'stack.tools': 'TOOLS & DB',
    'stack.ai': 'AI TOOLS',
    'cmd.stack': '$ cat ~/stack.txt',
    'win.stack': '~/stack.txt',
    ...
    'now.buildVal': 'sistem absensi siswa — Next.js + React (frontend), Node.js + Express.js (API), dan pengenalan wajah',
    'now.learnVal': 'Next.js, React, Node.js, Express.js, Flutter, Dart, dan integrasi face recognition',
    ...
    'exp1.desc': 'Siswa kelas XII RPL 2 di SMK Jakarta Pusat 1 — mendalami pengembangan web full stack: Node.js, Express.js, dan EJS di sisi server, Flutter & Dart untuk aplikasi mobile, serta basis data (MySQL).',
  ...
  en: {
    ...
    'now.open': 'open to',
    'now.buildVal': 'student attendance system — Next.js + React (frontend), Node.js + Express.js (API), and face recognition',
    'now.learnVal': 'Next.js, React, Node.js, Express.js, Flutter, Dart, and face recognition integration',
    ...
    'exp1.desc': 'Grade XII student of RPL 2 at SMK Jakarta Pusat 1 — diving into full stack web development: Node.js, Express.js, and EJS on the server side, Flutter & Dart for mobile apps, plus databases (MySQL).',
    'exp.ongoing': 'ongoing',
    'exp.done': 'completed',
  ...
  ja: {
    ...
    'exp1.desc': 'SMKジャカルタ中央1のRPL 2（ソフトウェアエンジニアリング科）12年生。フルスタックWeb開発（Node.js、Express.js、EJS）とモバイルアプリ開発（Flutter、Dart）、データベース（MySQL）を学んでいます。',
    'exp.ongoing': '在学中',
    'exp.done': '完了',
    ...
    'now.learn': '現在学習中',
    'now.open': '募集中',
    'now.buildVal': '生徒の出席管理システム — Next.js + React（フロントエンド）、Node.js + Express.js（API）、顔認証',
    'now.learnVal': 'Next.js、React、Node.js、Express.js、Flutter、Dart、顔認証の統合',
